// this is a patch version of the file at https://github.com/ClearCanvas/ClearCanvas/blob/master/Dicom/Utilities/Rules/Specifications/DicomExpression.cs
// see https://github.com/ClearCanvas/ClearCanvas/pull/154 for more
	...
	public class DicomExpression : Expression
	{
		...
		public override object Evaluate(object arg)
		{
			...
			if (Text.StartsWith("$"))
			{
				...
				var collection = arg as IDicomAttributeProvider;
		...
		private void ScanCollection(IDicomAttributeProvider collection, string[] tagArray, int startIndex, List<DicomAttribute> attributeList)
		{
